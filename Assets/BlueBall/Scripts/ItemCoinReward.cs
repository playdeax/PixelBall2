...
public class ItemCoinReward : MonoBehaviour
{
    public Image icon;
    ...
    Vector3 posStart;
    Vector3 posEnd;
    float valueReward = 100;
    public void ShowCoin(Vector3 _posStart,Vector3 _posEnd,float _valueReward) {
